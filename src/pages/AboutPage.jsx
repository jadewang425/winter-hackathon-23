...
const AboutPage = () => {
  ...
  return (
    <div className='max-w-[100%] flex flex-col items-center pt-5' >
      ...
      <div className='max-w-6xl w-full flex flex-col justify-start gap-5 items-start md:items-center md:flex-row p-5 my-5'>
        <div className="w-full self-center md:w-[50%]">
